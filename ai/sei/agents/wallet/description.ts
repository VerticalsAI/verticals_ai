...
${SEI_BALANCE_NAME} and ${SEI_ALL_BALANCES_NAME} require a wallet address as input, so you will have to use ${SEI_GET_WALLET_ADDRESS_NAME} to get the wallet address first.
