      ...
      <div className="flex flex-col items-center justify-center h-screen pt-16 pb-4">
        <div className="w-full h-full flex flex-col items-center justify-center gap-4">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            <h1 className="text-4xl font-bold text-white">Meet VERTICALS AI</h1>
            <p className="">
              Smart AI agents optimizing your stablecoin yields through
              data-driven strategies and market insights.
            </p>
            <LoginButton />
          </div>
