...
import GetTopYieldTokens from "./solana/get-top-yield-tokens";
...
const ToolInvocation: React.FC<Props> = ({ tool, prevToolAgent }) => {
  ...
  switch (toolName) {
    ...
    case SOLANA_GET_TOP_YIELD_TOKENS_NAME:
      return <GetTopYieldTokens tool={tool} prevToolAgent={prevToolAgent} />;
    default:
      return (
