...
${ETHEREUM_BALANCE_NAME} and ${ETHEREUM_ALL_BALANCES_NAME} require a wallet address as input, so you will have to use ${SOLANA_GET_WALLET_ADDRESS_NAME} to get the wallet address first.
