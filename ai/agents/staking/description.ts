...
${SOLANA_DEPOSIT_NAME} require a token address for the liquid staking token as input.

If the user provides a symbol of the token they want to stake into our out of, use the ${SOLANA_GET_TOKEN_ADDRESS_NAME} tool to get the token address.
...
The ${SOLANA_LIQUID_STAKING_YIELDS_NAME} tool will return the highest-yielding liquid staking tokens, which will include the token address.
