...
If a user asks to stake and provides a symbol, use the ${SEI_GET_TOKEN_ADDRESS_NAME} tool to get the contract address of the liquid staking provider to use.
If a user asks to stake and provides a name, ask them for the symbol first.

If a user asks to stake without a symbol or a name, use the ${SEI_LIQUID_STAKING_YIELDS_NAME} tool to get the best liquid staking yields and ask the user to choose one.`;
